...
import { CategoryInfoPersonalItems } from '@/src/types/models'
import { CategoryInfoPersonalItemsEnum } from '@/src/enums/categories'
import SpecificationsItem from '@/src/components/atoms/SpecificationsItem'

type Props = {
  categoryInfo: CategoryInfoPersonalItems
}

const PersonalItemsSpecifications = ({ categoryInfo }: Props) => {
  const { palette } = useTheme()

  const { t } = useTranslation('ad')

  const array = [
    { field: CategoryInfoPersonalItemsEnum.ItemType, type: SpecificationItemType.Title },
    { field: CategoryInfoPersonalItemsEnum.Quality, type: SpecificationItemType.Title },
  ]
...
export default PersonalItemsSpecifications
