...
const SparePartsAdCreateForm = () => {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...initialValues,
      categoryInfo: {
        [spareParts.key as KeysSubcategories]: spareParts.array[0],
        [spareParts.additional[0].key as KeysSubcategories]: spareParts.additional[0].array[0],
