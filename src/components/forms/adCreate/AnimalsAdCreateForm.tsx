...
const AnimalsAdCreateForm: React.FC<adCreateFormProps> = ({
  currentInitialValues,
  categoryName,
  objectId,
  submitHandler,
}) => {
  const { t } = useTranslation(['common', 'forms', 'notifications'])
  ...
  const initialValues: SaveAdForm = {
    ...
    categoryInfo: {
      [animals.key as KeysSubcategories]:
          ...
          <SimpleParamsField
            handleChange={item =>
              formik.setFieldValue(
                'categoryInfo',
                { ...formik.values.categoryInfo, [animals.key as string]: item },
                true
              )
            }
            collection={animals.array}
            selected={formik.values.categoryInfo[animals.key as KeysSubcategories]}
          />
        </Grid>
...
export default AnimalsAdCreateForm
